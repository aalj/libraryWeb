 ...
 */
@WebServlet("/BorrowingBookServlet")
public class BorrowingBookServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<BorrowTable> borrowingHByStuId = borrowingHistoryDaoIml.BorrowingByStuId(nStu_id, npage); 
